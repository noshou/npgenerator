...
/**
 * {@code TestCube} is a utility class used to test and benchmark the construction
 * of a {@link Cube} shape from given lattice parameters and atomic basis.
 * <p>
...
public class TestCube {
    ...
    /**
     * Builds a {@link Cube} structure using the provided parameters and returns
     ...
     *                          <li>{@code args[3]} — test name (used for file and structure metada10ta)</li>
    ...
    public long runTest(
        ...
        if (args.length != 5) {
            System.err.println(
                    ...
                    Example: TestSphere.runTest({10, 0.408, FCC, cube_au, nanometer})
                    """
            );
            return -1;
        }
        ...
        Shape test = new Cube(
                ...
                "cube_test_" + args[3],   // file name
                "cube_test_" + args[3],   // structure name
                "cube_test_" + args[3]    // structure index
        );
