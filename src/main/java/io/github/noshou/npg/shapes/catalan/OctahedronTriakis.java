...
import io.github.noshou.npg.shapes.archimedean.CubeTruncated;
...
/**
 * Represents a <b>Triakis Octahedron</b>.
 * <p>This Catalan solid is the dual of the {@link CubeTruncated}. It is formed by
 * augmenting each face of a {@link Octahedron} with a triangular pyramid,
 * resulting in a convex polyhedron with 24 identical isosceles triangular faces,
 * 36 edges, and 14 vertices. The shape exhibits octahedral symmetry (Oh)
 * @see <a href="https://dmccooey.com/polyhedra/TriakisOctahedron.html">
 *      Triakis Octahedron (David McCooey)</a>
 */
