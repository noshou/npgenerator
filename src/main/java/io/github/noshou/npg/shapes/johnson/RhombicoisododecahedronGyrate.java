 ...
 * <p>This polyhedron is formed by taking a {@link Rhombicosidodecahedron} and rotating one of
 * its pentagonal cupola by 36 degrees.
 * <p> It consists of:
 * <ul>
 *     <li>60 vertices</li>
 *     <li>120 edges</li>
 ...
 * @see <a href="https://dmccooey.com/polyhedra/GyrateRhombicosidodecahedron.html">
 *      Metabiyrate Rhombicosidodecahedron (David McCooey)</a>
 */
public class RhombicoisododecahedronGyrate extends RhombicoisododecahedronGyrateAbstract {
    public RhombicoisododecahedronGyrate (
        ...
        squares.add(new Tetrad<>(vertices.get(18),vertices.get(22),vertices.get(23),vertices.get(19)));
        ...
        triangles.add(new Triad<>(vertices.get(33),vertices.get(18),vertices.get(19)));
        triangles.add(new Triad<>(vertices.get(34),vertices.get(48),vertices.get(56)));
        triangles.add(new Triad<>(vertices.get(35),vertices.get(23),vertices.get(22)));
