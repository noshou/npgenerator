...
/**
 * Represents a <b>Truncated Tetrahedron</b>.
 * <p> An Archimedean solid with 4 regular hexagonal faces, 4 equilateral
 * triangular faces, 18 edges, and 12 vertices.
 * It is derived from a regular {@link Tetrahedron} by truncating (cutting off)
 * each vertex so that one third of each edge is removed.
 * @see <a href="https://dmccooey.com/polyhedra/TruncatedTetrahedron.html">
 *      Truncated Tetrahedron (David McCooey)</a>
 */
...
public class TetrahedronTruncated extends Shape {
    ...
    public TetrahedronTruncated(
        ...
        Triad<Apfloat> hex0_norm = normalHex(vC0, vC4, vC5, vC9, vC10, vC2, true);
        Hexad<Tuple<Apfloat>> hex1 = new Hexad<>(vC1, vC5, vC4, vC8, vC11, vC3);
        Triad<Apfloat> hex1_norm = normalHex(vC1, vC5, vC4, vC8, vC11, vC3, true);
        Hexad<Tuple<Apfloat>> hex2 = new Hexad<>(vC2, vC6, vC7, vC11, vC8, vC0);
        Triad<Apfloat> hex2_norm = normalHex(vC2, vC6, vC7, vC11, vC8, vC0, true);
        Hexad<Tuple<Apfloat>> hex3 = new Hexad<>(vC3, vC7, vC6, vC10, vC9, vC1);
        Triad<Apfloat> hex3_norm = normalHex(vC3, vC7, vC6, vC10, vC9, vC1, true);
        ...
        Triad<Apfloat> tri0_norm = normalTriple(vC0, vC8, vC4, true);
        Triad<Tuple<Apfloat>> tri1 = new Triad<>(vC1, vC9, vC5);
        Triad<Apfloat> tri1_norm = normalTriple(vC1, vC9, vC5, true);
        Triad<Tuple<Apfloat>> tri2 = new Triad<>(vC2, vC10, vC6);
        Triad<Apfloat> tri2_norm = normalTriple(vC2, vC10, vC6, true);
        Triad<Tuple<Apfloat>> tri3 = new Triad<>(vC3, vC11, vC7);
        Triad<Apfloat> tri3_norm = normalTriple(vC3, vC11, vC7, true);
    ...
    protected boolean inBounds(@NotNull Triad<Apfloat> point_cart) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            Triad<Apfloat> m_h = subs(point_cart, vertA_h);
            ...
            Apfloat d_h = dot_prod(norm_h, m_h);
