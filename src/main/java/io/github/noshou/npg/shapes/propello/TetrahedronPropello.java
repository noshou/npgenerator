package io.github.noshou.npg.shapes.propello;
...
/**
 * Represents a <b>Propello Tetrahedron</b>.
 * <p> This polyhedron is a tetrahedrally symmetric variation of a {@link Tetrahedron},
 * modified so that each face is twisted in a propeller-like fashion.
 * <p> The result is a chiral, convex polyhedron with 12 congruent scalene triangular faces,
 * 8 vertices, and 18 edges.
 * @see <a href="https://dmccooey.com/polyhedra/PropelloTetrahedron.html">
 *      Propello Tetrahedron (David McCooey)</a>
 */
...
public class TetrahedronPropello extends Shape {
    ...
    public TetrahedronPropello(
        ...
        Triad<Apfloat> kte0_norm = normalQuad(vC12, vC0, vC2, vC10, true);
        Tetrad<Tuple<Apfloat>> kte1 = new Tetrad<>(vC12, vC10, vC9, vC5);
        Triad<Apfloat> kte1_norm = normalQuad(vC12, vC10, vC9, vC5, true);
        Tetrad<Tuple<Apfloat>> kte2 = new Tetrad<>(vC12, vC5, vC4, vC0);
        Triad<Apfloat> kte2_norm = normalQuad(vC12, vC5, vC4, vC0, true);
        Tetrad<Tuple<Apfloat>> kte3 = new Tetrad<>(vC13, vC1, vC3, vC11);
        Triad<Apfloat> kte3_norm = normalQuad(vC13, vC1, vC3, vC11, true);
        Tetrad<Tuple<Apfloat>> kte4 = new Tetrad<>(vC13, vC11, vC8, vC4);
        Triad<Apfloat> kte4_norm = normalQuad(vC13, vC11, vC8, vC4, true);
        Tetrad<Tuple<Apfloat>> kte5 = new Tetrad<>(vC13, vC4, vC5, vC1);
        Triad<Apfloat> kte5_norm = normalQuad(vC13, vC4, vC5, vC1, true);
        Tetrad<Tuple<Apfloat>> kte6 = new Tetrad<>(vC14, vC2, vC0, vC8);
        Triad<Apfloat> kte6_norm = normalQuad(vC14, vC2, vC0, vC8, true);
        Tetrad<Tuple<Apfloat>> kte7 = new Tetrad<>(vC14, vC8, vC11, vC7);
        Triad<Apfloat> kte7_norm = normalQuad(vC14, vC8, vC11, vC7, true);
        Tetrad<Tuple<Apfloat>> kte8 = new Tetrad<>(vC14, vC7, vC6, vC2);
        Triad<Apfloat> kte8_norm = normalQuad(vC14, vC7, vC6, vC2, true);
        Tetrad<Tuple<Apfloat>> kte9 = new Tetrad<>(vC15, vC3, vC1, vC9);
        Triad<Apfloat> kte9_norm = normalQuad(vC15, vC3, vC1, vC9, true);
        Tetrad<Tuple<Apfloat>> kte10 = new Tetrad<>(vC15, vC9, vC10, vC6);
        Triad<Apfloat> kte10_norm = normalQuad(vC15, vC9, vC10, vC6, true);
        Tetrad<Tuple<Apfloat>> kte11 = new Tetrad<>(vC15, vC6, vC7, vC3);
        Triad<Apfloat> kte11_norm = normalQuad(vC15, vC6, vC7, vC3, true);
        ...
        Triad<Apfloat> tri0_norm = normalTriple(vC0, vC4, vC8, true);
        Triad<Tuple<Apfloat>> tri1 = new Triad<>(vC1, vC5, vC9);
        Triad<Apfloat> tri1_norm = normalTriple(vC1, vC5, vC9, true);
        Triad<Tuple<Apfloat>> tri2 = new Triad<>(vC2, vC6, vC10);
        Triad<Apfloat> tri2_norm = normalTriple(vC2, vC6, vC10, true);
        Triad<Tuple<Apfloat>> tri3 = new Triad<>(vC3, vC7, vC11);
        Triad<Apfloat> tri3_norm = normalTriple(vC3, vC7, vC11, true);
