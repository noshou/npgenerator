...
/**
 * Represents a <b>Chamfered Cube</b>.
 * <p>
 * This polyhedron is formed by chamfering (cutting off) the edges of a cube,
 * creating new faces at each edge and resulting in a truncated form.
 * 
 * @see <a href="https://dmccooey.com/polyhedra/ChamferedCube3.html">
 *     Chamfered Cube (David McCooey)</a>
 */
@SuppressWarnings("FieldCanBeLocal")
public class CubeChamfered extends Shape {
    ...
    // C0 = (sqrt(6) - sqrt(2)) / 4
    private final Apfloat C0 = (SQRT6.subtract(SQRT2)).divide(N4);

    // C1 = sqrt(6) / 4
    private final Apfloat C1 = SQRT6.divide(N4);

    // C2 = (sqrt(6) + sqrt(2)) / 4
    private final Apfloat C2 = (SQRT6.add(SQRT2)).divide(N4);


    public CubeChamfered(
        ...
        Triad<Apfloat> vB0 = new Triad<>(C0, C0, C2);
        Triad<Apfloat> vB1 = new Triad<>(C0, C0, C2.multiply(NEG_N1));
        Triad<Apfloat> vB2 = new Triad<>(C0, C0.multiply(NEG_N1), C2);
        Triad<Apfloat> vB3 = new Triad<>(C0, C0.multiply(NEG_N1), C2.multiply(NEG_N1));
        Triad<Apfloat> vB4 = new Triad<>(C0.multiply(NEG_N1), C0, C2);
        Triad<Apfloat> vB5 = new Triad<>(C0.multiply(NEG_N1), C0, C2.multiply(NEG_N1));
        Triad<Apfloat> vB6 = new Triad<>(C0.multiply(NEG_N1), C0.multiply(NEG_N1), C2);
        Triad<Apfloat> vB7 = new Triad<>(C0.multiply(NEG_N1), C0.multiply(NEG_N1), C2.multiply(NEG_N1));
        Triad<Apfloat> vB8 = new Triad<>(C2, C0, C0);
        Triad<Apfloat> vB9 = new Triad<>(C2, C0, C0.multiply(NEG_N1));
        Triad<Apfloat> vB10 = new Triad<>(C2, C0.multiply(NEG_N1), C0);
        Triad<Apfloat> vB11 = new Triad<>(C2, C0.multiply(NEG_N1), C0.multiply(NEG_N1));
        Triad<Apfloat> vB12 = new Triad<>(C2.multiply(NEG_N1), C0, C0);
        Triad<Apfloat> vB13 = new Triad<>(C2.multiply(NEG_N1), C0, C0.multiply(NEG_N1));
        Triad<Apfloat> vB14 = new Triad<>(C2.multiply(NEG_N1), C0.multiply(NEG_N1), C0);
        Triad<Apfloat> vB15 = new Triad<>(C2.multiply(NEG_N1), C0.multiply(NEG_N1), C0.multiply(NEG_N1));
        Triad<Apfloat> vB16 = new Triad<>(C0, C2, C0);
        Triad<Apfloat> vB17 = new Triad<>(C0, C2, C0.multiply(NEG_N1));
        Triad<Apfloat> vB18 = new Triad<>(C0, C2.multiply(NEG_N1), C0);
        Triad<Apfloat> vB19 = new Triad<>(C0, C2.multiply(NEG_N1), C0.multiply(NEG_N1));
        Triad<Apfloat> vB20 = new Triad<>(C0.multiply(NEG_N1), C2, C0);
        Triad<Apfloat> vB21 = new Triad<>(C0.multiply(NEG_N1), C2, C0.multiply(NEG_N1));
        Triad<Apfloat> vB22 = new Triad<>(C0.multiply(NEG_N1), C2.multiply(NEG_N1), C0);
        Triad<Apfloat> vB23 = new Triad<>(C0.multiply(NEG_N1), C2.multiply(NEG_N1), C0.multiply(NEG_N1));
