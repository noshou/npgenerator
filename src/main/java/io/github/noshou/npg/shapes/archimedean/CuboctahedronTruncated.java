...
/**
 * Represents a <b>Truncated Cuboctahedron</b>
 * <p> An Archimedean solid with 48 vertices,
 * 26 faces (comprising 12 squares, 8 regular hexagons, and 6 regular octagons),
 * and 72 edges.
 * <p> It is derived from the {@link Cuboctahedron} by truncating (cutting off) its vertices
 * at one third of the edge length, producing the new polygonal faces.
 * This polyhedron is vertex-transitive, meaning all vertices share the same
 * arrangement of surrounding faces.
 * @see <a href="https://dmccooey.com/polyhedra/TruncatedCuboctahedron.html">
 * Truncated Cuboctahedron – dmccooey.com</a>
 */
@SuppressWarnings("FieldCanBeLocal")
public class CuboctahedronTruncated extends Shape {
    ...
    // C1 = (1 + 2 * sqrt(2)) / 2
    private final Apfloat C1 = (N1.add(N2.multiply(SQRT2))).divide(N2);

    public CuboctahedronTruncated(
        ...
        Triad<Apfloat> vB0 = new Triad<>(C0, FRAC_1_over_2, C1);
        Triad<Apfloat> vB1 = new Triad<>(C0, FRAC_1_over_2, C1.multiply(NEG_N1));
        Triad<Apfloat> vB2 = new Triad<>(C0, FRAC_1_over_2.multiply(NEG_N1), C1);
        Triad<Apfloat> vB3 = new Triad<>(C0, FRAC_1_over_2.multiply(NEG_N1), C1.multiply(NEG_N1));
        Triad<Apfloat> vB4 = new Triad<>(C0.multiply(NEG_N1), FRAC_1_over_2, C1);
        Triad<Apfloat> vB5 = new Triad<>(C0.multiply(NEG_N1), FRAC_1_over_2, C1.multiply(NEG_N1));
        Triad<Apfloat> vB6 = new Triad<>(C0.multiply(NEG_N1), FRAC_1_over_2.multiply(NEG_N1), C1);
        Triad<Apfloat> vB7 = new Triad<>(C0.multiply(NEG_N1), FRAC_1_over_2.multiply(NEG_N1), C1.multiply(NEG_N1));
        Triad<Apfloat> vB8 = new Triad<>(C1, C0, FRAC_1_over_2);
        Triad<Apfloat> vB9 = new Triad<>(C1, C0, FRAC_1_over_2.multiply(NEG_N1));
        Triad<Apfloat> vB10 = new Triad<>(C1, C0.multiply(NEG_N1), FRAC_1_over_2);
        Triad<Apfloat> vB11 = new Triad<>(C1, C0.multiply(NEG_N1), FRAC_1_over_2.multiply(NEG_N1));
        Triad<Apfloat> vB12 = new Triad<>(C1.multiply(NEG_N1), C0, FRAC_1_over_2);
        Triad<Apfloat> vB13 = new Triad<>(C1.multiply(NEG_N1), C0, FRAC_1_over_2.multiply(NEG_N1));
        Triad<Apfloat> vB14 = new Triad<>(C1.multiply(NEG_N1), C0.multiply(NEG_N1), FRAC_1_over_2);
        Triad<Apfloat> vB15 = new Triad<>(C1.multiply(NEG_N1), C0.multiply(NEG_N1), FRAC_1_over_2.multiply(NEG_N1));
        Triad<Apfloat> vB16 = new Triad<>(FRAC_1_over_2, C1, C0);
        Triad<Apfloat> vB17 = new Triad<>(FRAC_1_over_2, C1, C0.multiply(NEG_N1));
        Triad<Apfloat> vB18 = new Triad<>(FRAC_1_over_2, C1.multiply(NEG_N1), C0);
        Triad<Apfloat> vB19 = new Triad<>(FRAC_1_over_2, C1.multiply(NEG_N1), C0.multiply(NEG_N1));
        Triad<Apfloat> vB20 = new Triad<>(FRAC_1_over_2.multiply(NEG_N1), C1, C0);
        Triad<Apfloat> vB21 = new Triad<>(FRAC_1_over_2.multiply(NEG_N1), C1, C0.multiply(NEG_N1));
        Triad<Apfloat> vB22 = new Triad<>(FRAC_1_over_2.multiply(NEG_N1), C1.multiply(NEG_N1), C0);
        Triad<Apfloat> vB23 = new Triad<>(FRAC_1_over_2.multiply(NEG_N1), C1.multiply(NEG_N1), C0.multiply(NEG_N1));
        Triad<Apfloat> vB24 = new Triad<>(FRAC_1_over_2, C0, C1);
        Triad<Apfloat> vB25 = new Triad<>(FRAC_1_over_2, C0, C1.multiply(NEG_N1));
        Triad<Apfloat> vB26 = new Triad<>(FRAC_1_over_2, C0.multiply(NEG_N1), C1);
        Triad<Apfloat> vB27 = new Triad<>(FRAC_1_over_2, C0.multiply(NEG_N1), C1.multiply(NEG_N1));
        Triad<Apfloat> vB28 = new Triad<>(FRAC_1_over_2.multiply(NEG_N1), C0, C1);
        Triad<Apfloat> vB29 = new Triad<>(FRAC_1_over_2.multiply(NEG_N1), C0, C1.multiply(NEG_N1));
        Triad<Apfloat> vB30 = new Triad<>(FRAC_1_over_2.multiply(NEG_N1), C0.multiply(NEG_N1), C1);
        Triad<Apfloat> vB31 = new Triad<>(FRAC_1_over_2.multiply(NEG_N1), C0.multiply(NEG_N1), C1.multiply(NEG_N1));
        Triad<Apfloat> vB32 = new Triad<>(C1, FRAC_1_over_2, C0);
        Triad<Apfloat> vB33 = new Triad<>(C1, FRAC_1_over_2, C0.multiply(NEG_N1));
        Triad<Apfloat> vB34 = new Triad<>(C1, FRAC_1_over_2.multiply(NEG_N1), C0);
        Triad<Apfloat> vB35 = new Triad<>(C1, FRAC_1_over_2.multiply(NEG_N1), C0.multiply(NEG_N1));
        Triad<Apfloat> vB36 = new Triad<>(C1.multiply(NEG_N1), FRAC_1_over_2, C0);
        Triad<Apfloat> vB37 = new Triad<>(C1.multiply(NEG_N1), FRAC_1_over_2, C0.multiply(NEG_N1));
        Triad<Apfloat> vB38 = new Triad<>(C1.multiply(NEG_N1), FRAC_1_over_2.multiply(NEG_N1), C0);
        Triad<Apfloat> vB39 = new Triad<>(C1.multiply(NEG_N1), FRAC_1_over_2.multiply(NEG_N1), C0.multiply(NEG_N1));
        Triad<Apfloat> vB40 = new Triad<>(C0, C1, FRAC_1_over_2);
        Triad<Apfloat> vB41 = new Triad<>(C0, C1, FRAC_1_over_2.multiply(NEG_N1));
        Triad<Apfloat> vB42 = new Triad<>(C0, C1.multiply(NEG_N1), FRAC_1_over_2);
        Triad<Apfloat> vB43 = new Triad<>(C0, C1.multiply(NEG_N1), FRAC_1_over_2.multiply(NEG_N1));
        Triad<Apfloat> vB44 = new Triad<>(C0.multiply(NEG_N1), C1, FRAC_1_over_2);
        Triad<Apfloat> vB45 = new Triad<>(C0.multiply(NEG_N1), C1, FRAC_1_over_2.multiply(NEG_N1));
        Triad<Apfloat> vB46 = new Triad<>(C0.multiply(NEG_N1), C1.multiply(NEG_N1), FRAC_1_over_2);
        Triad<Apfloat> vB47 = new Triad<>(C0.multiply(NEG_N1), C1.multiply(NEG_N1), FRAC_1_over_2.multiply(NEG_N1));
