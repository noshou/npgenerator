...
/**
 * Represents a <b>Canonical {@link IcosahedronHexakis}</b> (aka Disdyakis Triacontahedron).
...
public class IcosahedronHexakisCanonical extends IcosahedronHexakis {
    ...
    public IcosahedronHexakisCanonical(
