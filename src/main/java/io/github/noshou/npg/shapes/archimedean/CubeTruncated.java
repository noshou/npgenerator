...
/**
 * Represents a <b>Truncated Cube</b>
 * <p> An Archimedean solid with 24 vertices, 36 edges,
 * and 14 faces (8 regular hexagons and 6 squares).
 * <p> The Truncated Cube is created by truncating (cutting off) the vertices of a
 * regular cube, resulting in a shape with more faces and a higher degree of symmetry.
 * @see <a href="https://dmccooey.com/polyhedra/TruncatedCube.html" target="_blank" rel="noopener noreferrer">
 * Truncated Cube polyhedron page</a>.
 */
...
public class CubeTruncated extends Shape {
    ...
    public CubeTruncated(
        ...
        Triad<Apfloat> oct0_norm = normalOct(vC0, vC2, vC10, vC11, vC3, vC1, vC9, vC8, true);
        Octad<Tuple<Apfloat>> oct1 = new Octad<>(vC0, vC16, vC20, vC4, vC6, vC22, vC18, vC2);
        Triad<Apfloat> oct1_norm = normalOct(vC0, vC16, vC20, vC4, vC6, vC22, vC18, vC2, true);
        Octad<Tuple<Apfloat>> oct2 = new Octad<>(vC12, vC13, vC5, vC7, vC15, vC14, vC6, vC4);
        Triad<Apfloat> oct2_norm = normalOct(vC12, vC13, vC5, vC7, vC15, vC14, vC6, vC4, true);
        Octad<Tuple<Apfloat>> oct3 = new Octad<>(vC12, vC20, vC16, vC8, vC9, vC17, vC21, vC13);
        Triad<Apfloat> oct3_norm = normalOct(vC12, vC20, vC16, vC8, vC9, vC17, vC21, vC13, true);
        Octad<Tuple<Apfloat>> oct4 = new Octad<>(vC19, vC23, vC7, vC5, vC21, vC17, vC1, vC3);
        Triad<Apfloat> oct4_norm = normalOct(vC19, vC23, vC7, vC5, vC21, vC17, vC1, vC3, true);
        Octad<Tuple<Apfloat>> oct5 = new Octad<>(vC19, vC11, vC10, vC18, vC22, vC14, vC15, vC23);
        Triad<Apfloat> oct5_norm = normalOct(vC19, vC11, vC10, vC18, vC22, vC14, vC15, vC23, true);
