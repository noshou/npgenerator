...
/**
 * Represents a <b>Biscribed {@link IcosahedronHexakis}</b> (aka Disdyakis Triacontahedron).
...
public class IcosahedronHexakisBiscribed extends IcosahedronHexakis {
    ...
    public IcosahedronHexakisBiscribed(
