...
/**
 * Represents a <b>Disdyakis Triacontahedron</b> (aka Hexakis Icosahedron).
 ...
 * <ul>
 *   <li>{@link TriacontahedronDisdyakisCanonical} is the regular, symmetric form with uniform face geometry.</li>
 *   <li>{@link TriacontahedronDisdyakisBiscribed} is positioned between two concentric spheres—
...
public abstract class TriacontahedronDisdyakis extends Shape {
    ...
    public TriacontahedronDisdyakis(
    ...
    /**
     * must be called by child classes to construct shape
     */
