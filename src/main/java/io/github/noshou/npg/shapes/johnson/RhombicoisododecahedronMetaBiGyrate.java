...
/**
 * <p> Represents a <b>Metabiyrate Rhombicosidodecahedron</b>
 * <p>This polyhedron is formed by taking a {@link Rhombicosidodecahedron} and rotating two
 * non-opposing pentagonal cupola by 36 degrees.
 * <p> It consists of:
 * <ul>
 *     <li>60 vertices</li>
 *     <li>120 edges</li>
 ...
 * @see <a href="https://dmccooey.com/polyhedra/MetabigyrateRhombicosidodecahedron.html">
 *      Metabiyrate Rhombicosidodecahedron (David McCooey)</a>
 */
public class RhombicoisododecahedronMetaBiGyrate extends RhombicoisododecahedronGyrateAbstract {
        public RhombicoisododecahedronMetaBiGyrate (
            ...
            // ==== BASIS VERTICES ====
            vB0  = new Triad<>(HALF(),NEG_HALF(),C9());
            vB1  = new Triad<>(HALF(),NEG_HALF(),NEG_C9());
            vB2  = new Triad<>(NEG_HALF(),HALF(),C9());
            vB3  = new Triad<>(NEG_HALF(),HALF(),NEG_C9());
            vB4  = new Triad<>(NEG_HALF(),NEG_HALF(),C9());
            vB5  = new Triad<>(NEG_HALF(),NEG_HALF(),NEG_C9());
            vB6  = new Triad<>(C9(),HALF(),HALF());
            vB7  = new Triad<>(C9(),HALF(),NEG_HALF());
            vB8  = new Triad<>(C9(),NEG_HALF(),HALF());
            vB9  = new Triad<>(C9(),NEG_HALF(),NEG_HALF());
            vB10 = new Triad<>(NEG_C9(),HALF(),HALF());
            vB11 = new Triad<>(NEG_C9(),HALF(),NEG_HALF());
            vB12 = new Triad<>(NEG_C9(),NEG_HALF(),HALF());
            vB13 = new Triad<>(NEG_C9(),NEG_HALF(),NEG_HALF());
            vB14 = new Triad<>(HALF(),C4(),C6());
            vB15 = new Triad<>(HALF(),C9(),NEG_HALF());
            vB16 = new Triad<>(HALF(),NEG_C4(),C6());
            vB17 = new Triad<>(HALF(),NEG_C9(),NEG_HALF());
            vB18 = new Triad<>(NEG_HALF(),C4(),C6());
            vB19 = new Triad<>(NEG_HALF(),C9(),NEG_HALF());
            vB20 = new Triad<>(NEG_HALF(),NEG_C4(),C6());
            vB21 = new Triad<>(NEG_HALF(),NEG_C9(),NEG_HALF());
            vB22 = new Triad<>(N0(),C10(),C0());
            vB23 = new Triad<>(N0(),C3(),NEG_C7());
            vB24 = new Triad<>(N0(),NEG_C10(),C0());
            vB25 = new Triad<>(N0(),NEG_C3(),NEG_C7());
            vB26 = new Triad<>(C7(),N0(),C3());
            vB27 = new Triad<>(C7(),N0(),NEG_C3());
            vB28 = new Triad<>(NEG_C7(),N0(),C3());
            vB29 = new Triad<>(NEG_C7(),N0(),NEG_C3());
            vB30 = new Triad<>(C3(),C7(),N0());
            vB31 = new Triad<>(C3(),NEG_C7(),N0());
            vB32 = new Triad<>(NEG_C3(),C7(),N0());
            vB33 = new Triad<>(NEG_C3(),NEG_C7(),N0());
            vB34 = new Triad<>(C3(),C1(),C5());
            vB35 = new Triad<>(C3(),C1(),NEG_C5());
            vB36 = new Triad<>(C3(),NEG_C1(),C5());
            vB37 = new Triad<>(C3(),NEG_C1(),NEG_C5());
            vB38 = new Triad<>(NEG_C3(),C1(),C5());
            vB39 = new Triad<>(NEG_C3(),C1(),NEG_C5());
            vB40 = new Triad<>(NEG_C3(),NEG_C1(),C5());
            vB41 = new Triad<>(NEG_C3(),NEG_C1(),NEG_C5());
            vB42 = new Triad<>(C5(),C3(),C1());
            vB43 = new Triad<>(C5(),C3(),NEG_C1());
            vB44 = new Triad<>(C5(),NEG_C3(),C1());
            vB45 = new Triad<>(C5(),NEG_C3(),NEG_C1());
            vB46 = new Triad<>(NEG_C5(),C3(),C1());
            vB47 = new Triad<>(NEG_C5(),C3(),NEG_C1());
            vB48 = new Triad<>(NEG_C5(),NEG_C3(),C1());
            vB49 = new Triad<>(NEG_C5(),NEG_C3(),NEG_C1());
            vB50 = new Triad<>(C1(),C8(),C2());
            vB51 = new Triad<>(C1(),C5(),NEG_C3());
            vB52 = new Triad<>(C1(),NEG_C8(),C2());
            vB53 = new Triad<>(C1(),NEG_C5(),NEG_C3());
            vB54 = new Triad<>(NEG_C1(),C8(),C2());
            vB55 = new Triad<>(NEG_C1(),C5(),NEG_C3());
            vB56 = new Triad<>(NEG_C1(),NEG_C8(),C2());
            vB57 = new Triad<>(NEG_C1(),NEG_C5(),NEG_C3());
            vB58 = new Triad<>(HALF(),NEG_HALF(),C9());
            vB59 = new Triad<>(HALF(),NEG_HALF(),C9());
