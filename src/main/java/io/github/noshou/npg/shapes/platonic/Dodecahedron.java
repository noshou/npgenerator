...
/**
 * Represents a <b>Dodecahedron</b>.
 * <p>
 * The dodecahedron is one of the five Platonic solids, characterized by 12 regular pentagonal faces,
 * 30 edges, and 20 vertices. It exhibits full icosahedral symmetry (Ih), making it highly symmetrical.
 * The dihedral angle between adjacent faces is approximately 116.565°, and its dual polyhedron is the icosahedron.
 * @see <a href="https://dmccooey.com/polyhedra/Dodecahedron.html">
 *      Dodecahedron (David McCooey)</a>
 */
...
public class Dodecahedron extends Shape {
    ...
    public Dodecahedron(
        ...
        Triad<Apfloat> pnt0_norm = normalPent(vC0, vC2, vC14, vC4, vC12, true);
        Pentad<Tuple<Apfloat>> pnt1 = new Pentad<>(vC0, vC12, vC8, vC10, vC16);
        Triad<Apfloat> pnt1_norm = normalPent(vC0, vC12, vC8, vC10, vC16, true);
        Pentad<Tuple<Apfloat>> pnt2 = new Pentad<>(vC0, vC16, vC6, vC18, vC2);
        Triad<Apfloat> pnt2_norm = normalPent(vC0, vC16, vC6, vC18, vC2, true);
        Pentad<Tuple<Apfloat>> pnt3 = new Pentad<>(vC7, vC6, vC16, vC10, vC17);
        Triad<Apfloat> pnt3_norm = normalPent(vC7, vC6, vC16, vC10, vC17, true);
        Pentad<Tuple<Apfloat>> pnt4 = new Pentad<>(vC7, vC17, vC1, vC3, vC19);
        Triad<Apfloat> pnt4_norm = normalPent(vC7, vC17, vC1, vC3, vC19, true);
        Pentad<Tuple<Apfloat>> pnt5 = new Pentad<>(vC7, vC19, vC11, vC18, vC6);
        Triad<Apfloat> pnt5_norm = normalPent(vC7, vC19, vC11, vC18, vC6, true);
        Pentad<Tuple<Apfloat>> pnt6 = new Pentad<>(vC9, vC11, vC19, vC3, vC15);
        Triad<Apfloat> pnt6_norm = normalPent(vC9, vC11, vC19, vC3, vC15, true);
        Pentad<Tuple<Apfloat>> pnt7 = new Pentad<>(vC9, vC15, vC5, vC4, vC14);
        Triad<Apfloat> pnt7_norm = normalPent(vC9, vC15, vC5, vC4, vC14, true);
        Pentad<Tuple<Apfloat>> pnt8 = new Pentad<>(vC9, vC14, vC2, vC18, vC11);
        Triad<Apfloat> pnt8_norm = normalPent(vC9, vC14, vC2, vC18, vC11, true);
        Pentad<Tuple<Apfloat>> pnt9 = new Pentad<>(vC13, vC1, vC17, vC10, vC8);
        Triad<Apfloat> pnt9_norm = normalPent(vC13, vC1, vC17, vC10, vC8, true);
        Pentad<Tuple<Apfloat>> pnt10 = new Pentad<>(vC13, vC8, vC12, vC4, vC5);
        Triad<Apfloat> pnt10_norm = normalPent(vC13, vC8, vC12, vC4, vC5, true);
        Pentad<Tuple<Apfloat>> pnt11 = new Pentad<>(vC13, vC5, vC15, vC3, vC1);
        Triad<Apfloat> pnt11_norm = normalPent(vC13, vC5, vC15, vC3, vC1, true);
        faces = new Dodecad<>(
                pnt0, pnt1, pnt2,
                pnt3, pnt4, pnt5,
                pnt6, pnt7, pnt8,
