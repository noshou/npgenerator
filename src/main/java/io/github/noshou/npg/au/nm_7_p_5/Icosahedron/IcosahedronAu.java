package io.github.noshou.npg.au.nm_7_p_5.Icosahedron;
 ...
 * spherical nanoparticle using the {@link Icosahedron} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class IcosahedronAu {
     ...
     * <p>
     * It creates a {@link Icosahedron} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auIcosahedra = new Icosahedron(
                radius,
                units,
                lattice_type,
                precision,
