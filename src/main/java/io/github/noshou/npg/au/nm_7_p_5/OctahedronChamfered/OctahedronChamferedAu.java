package io.github.noshou.npg.au.nm_7_p_5.OctahedronChamfered;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.platonic.chamfered.OctahedronChamfered;
 ...
 * spherical nanoparticle using the {@link OctahedronChamfered} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class OctahedronChamferedAu {
     ...
     * <p>
     * It creates a {@link OctahedronChamfered} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "OctahedronChamferedAu";
        ...
        Shape auChamferedOctahedron = new OctahedronChamfered(
                radius,
                units,
                lattice_type,
                precision,
