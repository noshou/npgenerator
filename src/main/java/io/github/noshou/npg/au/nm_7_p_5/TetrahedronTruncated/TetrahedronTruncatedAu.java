package io.github.noshou.npg.au.nm_7_p_5.TetrahedronTruncated;
 ...
 * spherical nanoparticle using the {@link TetrahedronTruncated} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class TetrahedronTruncatedAu {
     ...
     * <p>
     * It creates a {@link TetrahedronTruncated} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "TetrahedronTruncatedAu";
        ...
        Shape auTruncatedTetrahedron = new TetrahedronTruncated(
                radius,
                units,
                lattice_type,
                precision,
