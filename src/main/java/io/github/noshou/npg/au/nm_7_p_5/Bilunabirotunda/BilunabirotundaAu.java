package io.github.noshou.npg.au.nm_7_p_5.Bilunabirotunda;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.johnson.Bilunabirotunda;
 ...
 * spherical nanoparticle using the {@link Bilunabirotunda} class,
 * configured with user-defined radius, precision, and lattice parameters.
 * 
 */
public class BilunabirotundaAu {
     ...
     * <p>
     * It creates a {@link Bilunabirotunda} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auBilunabirotunda = new Bilunabirotunda(
                radius,
                units,
                lattice_type,
                precision,
