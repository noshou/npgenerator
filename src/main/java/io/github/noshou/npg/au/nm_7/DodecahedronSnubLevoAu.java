...
import io.github.noshou.npg.shapes.archimedean.DodecahedronSnubLevo;
 ...
 * spherical nanoparticle using the {@link DodecahedronSnubLevo} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class DodecahedronSnubLevoAu {
     ...
     * <p>
     * It creates a {@link DodecahedronSnubLevo} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "DodecahedronSnubLevoAu";
        ...
        Shape DodecahedronSnubLevo = new DodecahedronSnubLevo(
                radius,
                units,
                lattice_type,
                precision,
