package io.github.noshou.npg.au.nm_7_p_5.OctagonalPrism;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.prisms.PrismOctagonal;
 ...
 * spherical nanoparticle using the {@link PrismOctagonal} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class OctagonalPrismAu {
     ...
     * <p>
     * It creates a {@link PrismOctagonal} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auOctagonalPrism = new PrismOctagonal(
                radius,
                units,
                lattice_type,
                precision,
