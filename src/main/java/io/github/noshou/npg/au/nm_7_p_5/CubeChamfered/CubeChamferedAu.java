package io.github.noshou.npg.au.nm_7_p_5.CubeChamfered;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.platonic.chamfered.CubeChamfered;
 ...
 * spherical nanoparticle using the {@link CubeChamfered} class,
 * configured with user-defined radius, precision, and lattice parameters.
 * 
 */
public class CubeChamferedAu {
     ...
     * <p>
     * It creates a {@link CubeChamfered} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auTruncatedCube = new CubeChamfered(
                radius,
                units,
                lattice_type,
                precision,
