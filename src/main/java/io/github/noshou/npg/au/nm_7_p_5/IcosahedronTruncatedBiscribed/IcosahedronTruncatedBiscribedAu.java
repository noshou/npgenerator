package io.github.noshou.npg.au.nm_7_p_5.IcosahedronTruncatedBiscribed;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.archimedean.IcosahedronTruncatedBiscribed;
 ...
 * spherical nanoparticle using the {@link IcosahedronTruncatedBiscribed} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class IcosahedronTruncatedBiscribedAu {
     ...
     * <p>
     * It creates a {@link IcosahedronTruncatedBiscribed} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "IcosahedronTruncatedBiscribedAu";
        ...
        Shape auIcosahedra = new IcosahedronTruncatedBiscribed(
                radius,
                units,
                lattice_type,
                precision,
