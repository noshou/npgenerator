package io.github.noshou.npg.au.nm_7_p_5.CubeChamferedBiscribed;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.platonic.chamfered.CubeChamferedBiscribed;
 ...
 * spherical nanoparticle using the {@link CubeChamferedBiscribed} class,
 * configured with user-defined radius, precision, and lattice parameters.
 * 
 */
public class CubeChamferedBiscribedAu {
     ...
     * <p>
     * It creates a {@link CubeChamferedBiscribed} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "CubeChamferedBiscribedAu";
        ...
        Shape auTruncatedCube = new CubeChamferedBiscribed(
                radius,
                units,
                lattice_type,
                precision,
