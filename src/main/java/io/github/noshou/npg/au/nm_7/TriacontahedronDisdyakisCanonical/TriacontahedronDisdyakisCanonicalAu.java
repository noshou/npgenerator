package io.github.noshou.npg.au.nm_7.TriacontahedronDisdyakisCanonical;
 ...
 * spherical nanoparticle using the {@link TriacontahedronDisdyakisCanonical} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class TriacontahedronDisdyakisCanonicalAu {
     ...
     * <p>
     * It creates a {@link TriacontahedronDisdyakisCanonical} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "TriacontahedronDisdyakisCanonicalAu7nm";
        ...
        Shape auTruncatedOctahedron = new TriacontahedronDisdyakisCanonical(
                radius,
                units,
                lattice_type,
                precision,
