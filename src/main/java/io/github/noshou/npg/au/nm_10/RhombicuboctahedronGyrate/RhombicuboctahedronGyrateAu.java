package io.github.noshou.npg.au.nm_10.RhombicuboctahedronGyrate;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.Shape;
import io.github.noshou.npg.shapes.johnson.RhombicuboctahedronGyrate;
 ...
 * spherical nanoparticle using the {@link RhombicuboctahedronGyrate} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class RhombicuboctahedronGyrateAu {
     ...
     * <p>
     * It creates a {@link RhombicuboctahedronGyrate} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "RhombicuboctahedronGyrateAu";
        ...
        Shape auRhombicuboctahedronGyrate = new RhombicuboctahedronGyrate(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auRhombicuboctahedronGyrate.build();
