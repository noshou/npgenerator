package io.github.noshou.npg.au.nm_7_p_5.HexecontahedronPentagonalLevo;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.catalan.HexecontahedronPentagonalLevo;
 ...
 * spherical nanoparticle using the {@link HexecontahedronPentagonalLevo} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class HexecontahedronPentagonalLevoAu {
     ...
     * <p>
     * It creates a {@link HexecontahedronPentagonalLevo} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "HexecontahedronPentagonalLevoAu";
        ...
        Shape auHexecontahedronPentagonalLevo = new HexecontahedronPentagonalLevo(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auHexecontahedronPentagonalLevo.build();
