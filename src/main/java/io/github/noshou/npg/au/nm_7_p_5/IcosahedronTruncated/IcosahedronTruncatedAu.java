package io.github.noshou.npg.au.nm_7_p_5.IcosahedronTruncated;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.archimedean.IcosahedronTruncated;
 ...
 * spherical nanoparticle using the {@link IcosahedronTruncated} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class IcosahedronTruncatedAu {
     ...
     * <p>
     * It creates a {@link IcosahedronTruncated} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "IcosahedronTruncatedAu";
        ...
        Shape auIcosahedra = new IcosahedronTruncated(
                radius,
                units,
                lattice_type,
                precision,
