package io.github.noshou.npg.au.nm_10.RhombicoisododecahedronParaBiGyrate;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.Shape;
import io.github.noshou.npg.shapes.johnson.RhombicoisododecahedronParaBiGyrate;
 ...
 * spherical nanoparticle using the {@link RhombicoisododecahedronParaBiGyrate} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class RhombicoisododecahedronParaBiGyrateAu {
     ...
     * <p>
     * It creates a {@link RhombicoisododecahedronParaBiGyrate} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "RhombicoisododecahedronParaBiGyrateAu";
        ...
        Shape auRhombicoisododecahedronParaBiGyrate = new RhombicoisododecahedronParaBiGyrate(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auRhombicoisododecahedronParaBiGyrate.build();
