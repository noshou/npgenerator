package io.github.noshou.npg.au.nm_7.OctahedronTruncatedBiscribed;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.Shape;
import io.github.noshou.npg.shapes.archimedean.OctahedronTruncatedBiscribed;
 ...
 * spherical nanoparticle using the {@link OctahedronTruncatedBiscribed} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class OctahedronTruncatedBiscribedAu {
     ...
     * <p>
     * It creates a {@link OctahedronTruncatedBiscribed} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "OctahedronTruncatedBiscribedAu7nm";
        ...
        Shape auTruncatedOctahedron = new OctahedronTruncatedBiscribed(
                radius,
                units,
                lattice_type,
                precision,
