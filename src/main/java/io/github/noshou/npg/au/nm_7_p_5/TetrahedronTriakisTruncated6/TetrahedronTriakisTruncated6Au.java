package io.github.noshou.npg.au.nm_7_p_5.TetrahedronTriakisTruncated6;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.catalan.TetrahedronTriakisTruncated6;
 ...
 * spherical nanoparticle using the {@link TetrahedronTriakisTruncated6} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class TetrahedronTriakisTruncated6Au {
     ...
     * <p>
     * It creates a {@link TetrahedronTriakisTruncated6} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "TetrahedronTriakisTruncated6Au";
        ...
        Shape auTetrahedronTriakisTruncated6 = new TetrahedronTriakisTruncated6(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auTetrahedronTriakisTruncated6.build();
