package io.github.noshou.npg.au.nm_7_p_5.DodecahedronRhombic;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.catalan.DodecahedronRhombic;
 ...
 * spherical nanoparticle using the {@link DodecahedronRhombic} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class DodecahedronRhombicAu {
     ...
     * <p>
     * It creates a {@link DodecahedronRhombic} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "DodecahedronRhombicAu";
        ...
        Shape auRhombicDodecahedron = new DodecahedronRhombic(
                radius,
                units,
                lattice_type,
                precision,
