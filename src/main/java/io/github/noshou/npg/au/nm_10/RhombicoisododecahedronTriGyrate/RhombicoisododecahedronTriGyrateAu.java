package io.github.noshou.npg.au.nm_10.RhombicoisododecahedronTriGyrate;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.Shape;
import io.github.noshou.npg.shapes.johnson.RhombicoisododecahedronTriGyrate;
 ...
 * spherical nanoparticle using the {@link RhombicoisododecahedronTriGyrate} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class RhombicoisododecahedronTriGyrateAu {
     ...
     * <p>
     * It creates a {@link RhombicoisododecahedronTriGyrate} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "RhombicoisododecahedronTriGyrateAu";
        ...
        Shape auRhombicoisododecahedronTriGyrate = new RhombicoisododecahedronTriGyrate(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auRhombicoisododecahedronTriGyrate.build();
