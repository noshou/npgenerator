package io.github.noshou.npg.au.nm_7_p_5.HexecontahedronPentagonalDextro;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.catalan.HexecontahedronPentagonalDextro;
 ...
 * spherical nanoparticle using the {@link HexecontahedronPentagonalDextro} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class HexecontahedronPentagonalDextroAu {
     ...
     * <p>
     * It creates a {@link HexecontahedronPentagonalDextro} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "HexecontahedronPentagonalDextroAu";
        ...
        Shape auHexecontahedronPentagonalDextro = new HexecontahedronPentagonalDextro(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auHexecontahedronPentagonalDextro.build();
