package io.github.noshou.npg.au.nm_7_p_5.OctahedronTriakis;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.catalan.OctahedronTriakis;
 ...
 * spherical nanoparticle using the {@link OctahedronTriakis} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class OctahedronTriakisAu {
     ...
     * <p>
     * It creates a {@link OctahedronTriakis} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auTriakisOctahedron = new OctahedronTriakis(
                radius,
                units,
                lattice_type,
                precision,
