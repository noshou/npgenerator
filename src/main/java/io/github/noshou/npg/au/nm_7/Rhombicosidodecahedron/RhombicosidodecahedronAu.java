package io.github.noshou.npg.au.nm_7.Rhombicosidodecahedron;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.Shape;
import io.github.noshou.npg.shapes.archimedean.Rhombicosidodecahedron;
 ...
 * spherical nanoparticle using the {@link Rhombicosidodecahedron} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class RhombicosidodecahedronAu {
     ...
     * <p>
     * It creates a {@link Rhombicosidodecahedron} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "RhombicosidodecahedronAu";
        ...
        Shape auTruncatedRhombicuboctahedron = new Rhombicosidodecahedron(
                radius,
                units,
                lattice_type,
                precision,
