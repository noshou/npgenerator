package io.github.noshou.npg.au.nm_7_p_5.CuboctahedronTruncated;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.archimedean.CuboctahedronTruncated;
 ...
 * spherical nanoparticle using the {@link CuboctahedronTruncated} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class CuboctahedronTruncatedAu {
     ...
     * <p>
     * It creates a {@link CuboctahedronTruncated} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "CuboctahedronTruncatedAu";
        ...
        Shape auCuboctahedronTruncated = new CuboctahedronTruncated(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auCuboctahedronTruncated.build();
