package io.github.noshou.npg.au.nm_10.RhombicoisododecahedronGyrate;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.Shape;
import io.github.noshou.npg.shapes.johnson.RhombicoisododecahedronGyrate;
 ...
 * spherical nanoparticle using the {@link RhombicoisododecahedronGyrate} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class RhombicoisododecahedronGyrateAu {
     ...
     * <p>
     * It creates a {@link RhombicoisododecahedronGyrate} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "RhombicoisododecahedronGyrateAu";
        ...
        Shape auRhombicoisododecahedronGyrate = new RhombicoisododecahedronGyrate(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auRhombicoisododecahedronGyrate.build();
