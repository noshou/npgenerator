package io.github.noshou.npg.au.nm_7.RhombicuboctahedronTruncated;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.archimedean.RhombicuboctahedronTruncated;
 ...
 * spherical nanoparticle using the {@link RhombicuboctahedronTruncated} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class RhombicuboctahedronTruncatedAu {
     ...
     * <p>
     * It creates a {@link RhombicuboctahedronTruncated} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "RhombicuboctahedronTruncatedAu";
        ...
        Shape auTruncatedRhombicuboctahedron = new RhombicuboctahedronTruncated(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auTruncatedRhombicuboctahedron.build();
