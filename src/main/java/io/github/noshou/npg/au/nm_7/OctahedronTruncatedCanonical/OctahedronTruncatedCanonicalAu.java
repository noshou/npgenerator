package io.github.noshou.npg.au.nm_7.OctahedronTruncatedCanonical;
 ...
 */
public class OctahedronTruncatedCanonicalAu {
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "OctahedronTruncatedCanonicalAu7nm";
