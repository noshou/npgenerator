package io.github.noshou.npg.au.nm_7_p_5.Cuboctahedron;
 ...
 * spherical nanoparticle using the {@link Cuboctahedron} class,
 * configured with user-defined radius, precision, and lattice parameters.
 * 
 */
public class CuboctahedronAu {
     ...
     * <p>
     * It creates a {@link Cuboctahedron} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auCuboctahedron = new Cuboctahedron(
                radius,
                units,
                lattice_type,
                precision,
