package io.github.noshou.npg.au.nm_7_p_5.CuboctahedronTruncatedBiscribed;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.archimedean.CuboctahedronTruncatedBiscribed;
 ...
 * spherical nanoparticle using the {@link CuboctahedronTruncatedBiscribed} class,
 * configured with user-defined radius, precision, and lattice parameters.
 * 
 */
public class CuboctahedronTruncatedBiscribedAu {
     ...
     * <p>
     * It creates a {@link CuboctahedronTruncatedBiscribed} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "CuboctahedronTruncatedBiscribedAu";
        ...
        Shape auCuboctahedronTruncatedBiscribed = new CuboctahedronTruncatedBiscribed(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auCuboctahedronTruncatedBiscribed.build();
