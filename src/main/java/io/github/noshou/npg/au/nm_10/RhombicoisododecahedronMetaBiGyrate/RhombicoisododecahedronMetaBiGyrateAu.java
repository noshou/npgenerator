package io.github.noshou.npg.au.nm_10.RhombicoisododecahedronMetaBiGyrate;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.Shape;
import io.github.noshou.npg.shapes.johnson.RhombicoisododecahedronMetaBiGyrate;
 ...
 * spherical nanoparticle using the {@link RhombicoisododecahedronMetaBiGyrate} class,
 * configured with user-defined radius, precision, and lattice Metameters.
 */
public class RhombicoisododecahedronMetaBiGyrateAu {
     ...
     * <p>
     * It creates a {@link RhombicoisododecahedronMetaBiGyrate} using a specified radius and lattice constant,
     * builds the structure, and prints the execution time in a human-readable format.
     * @Metam args the command-line arguments (not used)
     */
    public static void main(String @NotNull [] args) {
        long start_time_init = System.nanoTime();

        // Configuration Metameters
        ...
        String id = "RhombicoisododecahedronMetaBiGyrateAu";
        ...
        Shape auRhombicoisododecahedronMetaBiGyrate = new RhombicoisododecahedronMetaBiGyrate(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auRhombicoisododecahedronMetaBiGyrate.build();
