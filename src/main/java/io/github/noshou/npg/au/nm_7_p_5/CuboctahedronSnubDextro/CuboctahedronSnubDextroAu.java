package io.github.noshou.npg.au.nm_7_p_5.CuboctahedronSnubDextro;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.archimedean.CuboctahedronSnubDextro;
 ...
 * spherical nanoparticle using the {@link CuboctahedronSnubDextro} class,
 * configured with user-defined radius, precision, and lattice parameters.
 * 
 */
public class CuboctahedronSnubDextroAu {
     ...
     * <p>
     * It creates a {@link CuboctahedronSnubDextro} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "CuboctahedronSnubDextroAu";
        ...
        Shape auCuboctahedronSnubDextro = new CuboctahedronSnubDextro(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auCuboctahedronSnubDextro.build();
