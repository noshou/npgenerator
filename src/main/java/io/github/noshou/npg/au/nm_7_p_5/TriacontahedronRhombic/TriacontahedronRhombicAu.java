package io.github.noshou.npg.au.nm_7_p_5.TriacontahedronRhombic;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.catalan.TriacontahedronRhombic;
 ...
 * <p> This class generates a default FCC atomic basis for gold and builds a
 * spherical nanoparticle using the {@link TriacontahedronRhombic} class,
 * configured with user-defined radius, precision, and lattice parameters.
 * 
 */
public class TriacontahedronRhombicAu {
     ...
     * <p>
     * It creates a {@link TriacontahedronRhombic} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "TriacontahedronRhombicAu";
        ...
        Shape auTriacontahedronRhombic = new TriacontahedronRhombic(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auTriacontahedronRhombic.build();
