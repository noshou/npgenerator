package io.github.noshou.npg.au.nm_7_p_5.Icosidodecahedron;
 ...
 * spherical nanoparticle using the {@link Icosidodecahedron} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class IcosidodecahedronAu {
     ...
     * <p>
     * It creates a {@link Icosidodecahedron} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auIcosidodecahedron = new Icosidodecahedron(
                radius,
                units,
                lattice_type,
                precision,
