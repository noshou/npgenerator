package io.github.noshou.npg.au.nm_7.DodecahedronSnubDextro;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.Shape;
import io.github.noshou.npg.shapes.archimedean.DodecahedronSnubDextro;
 ...
 * spherical nanoparticle using the {@link DodecahedronSnubDextro} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class DodecahedronSnubDextroAu {
     ...
     * <p>
     * It creates a {@link DodecahedronSnubDextro} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "DodecahedronSnubDextroAu";
        ...
        Shape DodecahedronSnubDextro = new DodecahedronSnubDextro(
                radius,
                units,
                lattice_type,
                precision,
