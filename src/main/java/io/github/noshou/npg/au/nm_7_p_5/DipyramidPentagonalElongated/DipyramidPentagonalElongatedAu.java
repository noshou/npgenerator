package io.github.noshou.npg.au.nm_7_p_5.DipyramidPentagonalElongated;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.johnson.DipyramidPentagonalElongated;
 ...
 * spherical nanoparticle using the {@link DipyramidPentagonalElongated} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class DipyramidPentagonalElongatedAu {
     ...
     * <p>
     * It creates a {@link DipyramidPentagonalElongated} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "DipyramidPentagonalElongatedAu";
        ...
        Shape auDipyramidPentagonalElongated = new DipyramidPentagonalElongated(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auDipyramidPentagonalElongated.build();
