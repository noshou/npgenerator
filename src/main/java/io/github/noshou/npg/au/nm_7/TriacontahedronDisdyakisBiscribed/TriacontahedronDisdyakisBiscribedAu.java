package io.github.noshou.npg.au.nm_7.TriacontahedronDisdyakisBiscribed;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.Shape;
import io.github.noshou.npg.shapes.catalan.TriacontahedronDisdyakisBiscribed;
 ...
 * spherical nanoparticle using the {@link TriacontahedronDisdyakisBiscribed} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class TriacontahedronDisdyakisBiscribedAu {
     ...
     * <p>
     * It creates a {@link TriacontahedronDisdyakisBiscribed} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auTruncatedOctahedron = new TriacontahedronDisdyakisBiscribed(
                radius,
                units,
                lattice_type,
                precision,
