package io.github.noshou.npg.au.nm_7_p_5.CubeTruncated;
 ...
 * spherical nanoparticle using the {@link CubeTruncated} class,
 * configured with user-defined radius, precision, and lattice parameters.
 * 
 */
public class CubeTruncatedAu {
     ...
     * <p>
     * It creates a {@link CubeTruncated} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auTruncatedCube = new CubeTruncated(
                radius,
                units,
                lattice_type,
                precision,
