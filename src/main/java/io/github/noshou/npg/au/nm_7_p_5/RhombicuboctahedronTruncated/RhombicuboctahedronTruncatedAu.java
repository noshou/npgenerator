package io.github.noshou.npg.au.nm_7_p_5.RhombicuboctahedronTruncated;
...
public class RhombicuboctahedronTruncatedAu {
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auRhombicuboctahedronTruncated = new RhombicuboctahedronTruncated(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auRhombicuboctahedronTruncated.build();
