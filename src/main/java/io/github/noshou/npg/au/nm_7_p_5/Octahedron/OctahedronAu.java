package io.github.noshou.npg.au.nm_7_p_5.Octahedron;
 ...
 * spherical nanoparticle using the {@link Octahedron} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class OctahedronAu {
     ...
     * <p>
     * It creates a {@link Octahedron} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auOctahedron = new Octahedron(
                radius,
                units,
                lattice_type,
                precision,
