package io.github.noshou.npg.au.nm_7_p_5.IcositetrahedronDeltoidal;
 ...
 * spherical nanoparticle using the {@link IcositetrahedronDeltoidal} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class IcositetrahedronDeltoidalAu {
     ...
     * <p>
     * It creates a {@link IcositetrahedronDeltoidal} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "IcositetrahedronDeltoidalAu";
        ...
        Shape auIcositetrahedronDeltoidal = new IcositetrahedronDeltoidal(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auIcositetrahedronDeltoidal.build();
