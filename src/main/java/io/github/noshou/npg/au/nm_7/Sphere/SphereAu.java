 ...
 * spherical nanoparticle using the {@link Sphere} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class SphereAu {
     ...
     * <p>
     * It creates a {@link Sphere} using a specified radius and lattice constant,
