package io.github.noshou.npg.au.nm_7_p_5.OrthobicupolaTriangular;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.johnson.OrthobicupolaTriangular;
 ...
 * spherical nanoparticle using the {@link OrthobicupolaTriangular } class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class OrthobicupolaTriangularAu {
     ...
     * <p>
     * It creates a {@link OrthobicupolaTriangular } using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "OrthobicupolaTriangularAu ";
        ...
        Shape auTriangularOrthobicupola  = new OrthobicupolaTriangular(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auTriangularOrthobicupola .build();
