package io.github.noshou.npg.au.nm_7.HexecontahedronDeltoidal;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.Shape;
import io.github.noshou.npg.shapes.catalan.HexecontahedronDeltoidal;
 ...
 * spherical nanoparticle using the {@link HexecontahedronDeltoidal} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class HexecontahedronDeltoidalAu {
     ...
     * <p>
     * It creates a {@link HexecontahedronDeltoidal} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "HexecontahedronDeltoidalAu7nm";
        ...
        Shape auTruncatedOctahedron = new HexecontahedronDeltoidal(
                radius,
                units,
                lattice_type,
                precision,
