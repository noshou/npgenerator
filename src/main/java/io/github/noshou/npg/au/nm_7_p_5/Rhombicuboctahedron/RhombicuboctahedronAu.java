package io.github.noshou.npg.au.nm_7_p_5.Rhombicuboctahedron;
 ...
 * spherical nanoparticle using the {@link Rhombicuboctahedron} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class RhombicuboctahedronAu {
     ...
     * <p>
     * It creates a {@link Rhombicuboctahedron} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "RhombicuboctahedronAu";
        ...
        Shape auRhombicuboctahedron = new Rhombicuboctahedron(
                radius,
                units,
                lattice_type,
                precision,
