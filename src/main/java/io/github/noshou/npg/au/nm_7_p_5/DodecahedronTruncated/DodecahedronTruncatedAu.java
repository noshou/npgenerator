package io.github.noshou.npg.au.nm_7_p_5.DodecahedronTruncated;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.archimedean.DodecahedronTruncated;
 ...
 * spherical nanoparticle using the {@link DodecahedronTruncated} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class DodecahedronTruncatedAu {
     ...
     * <p>
     * It creates a {@link DodecahedronTruncated} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "DodecahedronTruncatedAu";
        ...
        Shape auDodecahedronTruncated = new DodecahedronTruncated(
                radius,
                units,
                lattice_type,
                precision,
