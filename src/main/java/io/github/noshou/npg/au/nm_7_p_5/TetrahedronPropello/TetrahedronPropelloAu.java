package io.github.noshou.npg.au.nm_7_p_5.TetrahedronPropello;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.propello.TetrahedronPropello;
 ...
 * spherical nanoparticle using the {@link TetrahedronPropello} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class TetrahedronPropelloAu {
     ...
     * <p>
     * It creates a {@link TetrahedronPropello} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "TetrahedronPropelloAu";
        ...
        Shape auPropelloTetrahedron = new TetrahedronPropello(
                radius,
                units,
                lattice_type,
                precision,
