package io.github.noshou.npg.au.nm_7_p_5.TetrahedronChamfered;

import io.github.noshou.npg.atom.Atom;
import io.github.noshou.npg.lattice.LatticeType;
import io.github.noshou.npg.nputil.FormatExecTime;
import io.github.noshou.npg.shapes.*;
import io.github.noshou.npg.shapes.platonic.chamfered.TetrahedronChamfered;
 ...
 * spherical nanoparticle using the {@link TetrahedronChamfered} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class TetrahedronChamferedAu {
     ...
     * <p>
     * It creates a {@link TetrahedronChamfered} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "TetrahedronChamferedAu";
        ...
        Shape auChamferedTetrahedron = new TetrahedronChamfered(
                radius,
                units,
                lattice_type,
                precision,
