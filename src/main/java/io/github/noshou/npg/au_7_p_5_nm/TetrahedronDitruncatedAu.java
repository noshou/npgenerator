...
import io.github.noshou.npg.shapes.archimedean.TetrahedronDitruncated;
 ...
 * spherical nanoparticle using the {@link TetrahedronDitruncated} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class TetrahedronDitruncatedAu {
     ...
     * <p>
     * It creates a {@link TetrahedronDitruncated} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "TetrahedronDitruncatedAu";
        ...
        Shape auDitruncatedTetrahedron = new TetrahedronDitruncated(
                radius,
                units,
                lattice_type,
                precision,
        ...
        auDitruncatedTetrahedron.build();
