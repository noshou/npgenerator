 ...
 * spherical nanoparticle using the {@link IcosahedronHexakisCanonical} class,
...
public class IcosahedronHexakisAu {
     ...
     * <p>
     * It creates a {@link IcosahedronHexakisCanonical} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auTriakisOctahedron = new IcosahedronHexakisCanonical(
                radius,
                units,
                lattice_type,
                precision,
