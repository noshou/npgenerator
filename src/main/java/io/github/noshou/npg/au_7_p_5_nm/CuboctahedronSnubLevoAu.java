...
import io.github.noshou.npg.shapes.archimedean.CuboctahedronSnubLevo;
 ...
 * spherical nanoparticle using the {@link CuboctahedronSnubLevo} class,
 * configured with user-defined radius, precision, and lattice parameters.
 */
public class CuboctahedronSnubLevoAu {
     ...
     * <p>
     * It creates a {@link CuboctahedronSnubLevo} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        String id = "CuboctahedronSnubLevoAu";
        ...
        Shape auCuboctahedronSnubLevo = new CuboctahedronSnubLevo(
                radius,
                units,
                lattice_type,
                precision,
