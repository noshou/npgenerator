 ...
 */
class NpMmcifBuilder extends FileBuilder {
     ...
     */
    public NpMmcifBuilder(@NotNull String file_name) throws IOException {
        super(file_name, ".cif");
    }
    ...
    public void init(@Nullable Object initializer) throws IOException {
        if (!(initializer instanceof Shape s)) {
            throw new IllegalArgumentException("initializer must be of type Shape!");
        }
    ...
    public void addAtom(@NotNull Atom a) throws IOException {
        ...
        if (element.isEmpty()) {
            throw new IllegalArgumentException(
                    "Atom element cannot be null or empty"
            );
        }
