 ...
 * spherical nanoparticle using the {@link OctagonalPrism} class,
 * configured with user-defined radius, precision, and lattice parameters.
 * </p>
 */
public class AuOctagonalPrism {
     ...
     * <p>
     * It creates a {@link OctagonalPrism} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auOctagonalPrism = new OctagonalPrism(
                radius,
                units,
                lattice_type,
                precision,
