...
import Shapes.IcosahedronHexakis;
import Shapes.Shape;
 ...
 * spherical nanoparticle using the {@link IcosahedronHexakis} class,
...
public class IcosahedronHexakisAu {
     ...
     * <p>
     * It creates a {@link IcosahedronHexakis} using a specified radius and lattice constant,
    ...
    public static void main(String @NotNull [] args) {
        ...
        Shape auTriakisOctahedron = new IcosahedronHexakis(
                radius,
                units,
                lattice_type,
                precision,
