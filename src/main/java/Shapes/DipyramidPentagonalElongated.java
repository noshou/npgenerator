...
/**
 * {@link:<a href=https://dmccooey.com/polyhedra/ElongatedPentagonalDipyramid.txt...</a>}
 */
...
public class DipyramidPentagonalElongated extends Shape {
    ...
    public DipyramidPentagonalElongated(
        ...
        Triad<Apfloat> tri0_norm  = VectorMath.normalTriple(vC10, vC0, vC8, true);
        Triad<Tuple<Apfloat>> tri1  = new Triad<>(vC10, vC8, vC2);
        Triad<Apfloat> tri1_norm  = VectorMath.normalTriple(vC10, vC8, vC2, true);
        Triad<Tuple<Apfloat>> tri2  = new Triad<>(vC10, vC2, vC6);
        Triad<Apfloat> tri2_norm  = VectorMath.normalTriple(vC10, vC2, vC6, true);
        Triad<Tuple<Apfloat>> tri3  = new Triad<>(vC10, vC6, vC4);
        Triad<Apfloat> tri3_norm  = VectorMath.normalTriple(vC10, vC6, vC4, true);
        Triad<Tuple<Apfloat>> tri4  = new Triad<>(vC10, vC4, vC0);
        Triad<Apfloat> tri4_norm  = VectorMath.normalTriple(vC10, vC4, vC0, true);
        Triad<Tuple<Apfloat>> tri5  = new Triad<>(vC11, vC1, vC5);
        Triad<Apfloat> tri5_norm  = VectorMath.normalTriple(vC11, vC1, vC5, true);
        Triad<Tuple<Apfloat>> tri6  = new Triad<>(vC11, vC5, vC7);
        Triad<Apfloat> tri6_norm  = VectorMath.normalTriple(vC11, vC5, vC7, true);
        Triad<Tuple<Apfloat>> tri7  = new Triad<>(vC11, vC7, vC3);
        Triad<Apfloat> tri7_norm  = VectorMath.normalTriple(vC11, vC7, vC3, true);
        Triad<Tuple<Apfloat>> tri8  = new Triad<>(vC11, vC3, vC9);
        Triad<Apfloat> tri8_norm  = VectorMath.normalTriple(vC11, vC3, vC9, true);
        Triad<Tuple<Apfloat>> tri9  = new Triad<>(vC11, vC9, vC1);
        Triad<Apfloat> tri9_norm  = VectorMath.normalTriple(vC11, vC9, vC1, true);
        faces_tri = new Decad<>(
        ...
        Triad<Apfloat> sqr0_norm = VectorMath.normalQuad(vC0, vC1, vC9, vC8, true);
        Tetrad<Tuple<Apfloat>> sqr1 = new Tetrad<>(vC8, vC9, vC3, vC2);
        Triad<Apfloat> sqr1_norm = VectorMath.normalQuad(vC8, vC9, vC3, vC2, true);
        Tetrad<Tuple<Apfloat>> sqr2 = new Tetrad<>(vC2, vC3, vC7, vC6);
        Triad<Apfloat> sqr2_norm = VectorMath.normalQuad(vC2, vC3, vC7, vC6, true);
        Tetrad<Tuple<Apfloat>> sqr3 = new Tetrad<>(vC6, vC7, vC5, vC4);
        Triad<Apfloat> sqr3_norm = VectorMath.normalQuad(vC6, vC7, vC5, vC4, true);
        Tetrad<Tuple<Apfloat>> sqr4 = new Tetrad<>(vC4, vC5, vC1, vC0);
        Triad<Apfloat> sqr4_norm = VectorMath.normalQuad(vC4, vC5, vC1, vC0, true);
