...
/**
 * Represents the right-handed (dextro) enantiomorph of the Snub Cuboctahedron.
 * <p>
 * This chiral form is the mirror image of the Levo Snub Cuboctahedron.
 * Although identical in connectivity, the spatial configuration of the vertices
 * is reversed compared to the levo form.
 *
 * @see <a href="https://dmccooey.com/polyhedra/RsnubCube.txt">RsnubCube.txt – dmccooey.com</a>
 */
