...
/**
 * Represents the left-handed (levo) enantiomorph of the Snub Cuboctahedron.
 * <p>
 * This chiral form is the mirror image of the Dextro Snub Cuboctahedron.
 * All vertices and faces have the same local geometry, but their spatial orientation
 * is rotated in the opposite direction compared to its right-handed counterpart.
 *
 * @see <a href="https://dmccooey.com/polyhedra/LsnubCube.txt">LsnubCube.txt – dmccooey.com</a>
 */
