...
/**
 * {@link:<a <a href="https://dmccooey.com/polyhedra/TriakisTetrahedron.txt">...</a>...</a>}
 */
...
public class TetrahedronTriakis extends Shape {
    ...
    public TetrahedronTriakis (
        ...
        Triad<Apfloat> tri0_norm = VectorMath.normalTriple(vC4, vC0, vC2, true);
        Triad<Tuple<Apfloat>> tri1 = new Triad<>(vC4, vC2, vC1);
        Triad<Apfloat> tri1_norm = VectorMath.normalTriple(vC4, vC2, vC1, true);
        Triad<Tuple<Apfloat>> tri2 = new Triad<>(vC4, vC1, vC0);
        Triad<Apfloat> tri2_norm = VectorMath.normalTriple(vC4, vC1, vC0, true);
        Triad<Tuple<Apfloat>> tri3 = new Triad<>(vC5, vC0, vC1);
        Triad<Apfloat> tri3_norm = VectorMath.normalTriple(vC5, vC0, vC1, true);
        Triad<Tuple<Apfloat>> tri4 = new Triad<>(vC5, vC1, vC3);
        Triad<Apfloat> tri4_norm = VectorMath.normalTriple(vC5, vC1, vC3, true);
        Triad<Tuple<Apfloat>> tri5 = new Triad<>(vC5, vC3, vC0);
        Triad<Apfloat> tri5_norm = VectorMath.normalTriple(vC5, vC3, vC0, true);
        Triad<Tuple<Apfloat>> tri6 = new Triad<>(vC6, vC0, vC3);
        Triad<Apfloat> tri6_norm = VectorMath.normalTriple(vC6, vC0, vC3, true);
        Triad<Tuple<Apfloat>> tri7 = new Triad<>(vC6, vC3, vC2);
        Triad<Apfloat> tri7_norm = VectorMath.normalTriple(vC6, vC3, vC2, true);
        Triad<Tuple<Apfloat>> tri8 = new Triad<>(vC6, vC2, vC0);
        Triad<Apfloat> tri8_norm = VectorMath.normalTriple(vC6, vC2, vC0, true);
        Triad<Tuple<Apfloat>> tri9 = new Triad<>(vC7, vC1, vC2);
        Triad<Apfloat> tri9_norm = VectorMath.normalTriple(vC7, vC1, vC2, true);
        Triad<Tuple<Apfloat>> tri10 = new Triad<>(vC7, vC2, vC3);
        Triad<Apfloat> tri10_norm = VectorMath.normalTriple(vC7, vC2, vC3, true);
        Triad<Tuple<Apfloat>> tri11 = new Triad<>(vC7, vC3, vC1);
        Triad<Apfloat> tri11_norm = VectorMath.normalTriple(vC7, vC3, vC1, true);
