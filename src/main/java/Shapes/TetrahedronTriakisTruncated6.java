...
/**
 * {@link:<a <a href=https://dmccooey.com/polyhedra/6TruncatedTriakisTetrahedron2.txt>...</a>...</a>}
 */
...
public class TetrahedronTriakisTruncated6 extends Shape {
    ...
    public TetrahedronTriakisTruncated6(
        ...
        Triad<Apfloat> pnt0_norm = VectorMath.normalPent(vC24, vC12, vC0, vC2, vC20, true);
        Pentad<Tuple<Apfloat>> pnt1 = new Pentad<>(vC24, vC20, vC10, vC9, vC16);
        Triad<Apfloat> pnt1_norm = VectorMath.normalPent(vC24, vC20, vC10, vC9, vC16, true);
        Pentad<Tuple<Apfloat>> pnt2 = new Pentad<>(vC24, vC16, vC5, vC4, vC12);
        Triad<Apfloat> pnt2_norm = VectorMath.normalPent(vC24, vC16, vC5, vC4, vC12, true);
        Pentad<Tuple<Apfloat>> pnt3 = new Pentad<>(vC25, vC13, vC1, vC3, vC21);
        Triad<Apfloat> pnt3_norm = VectorMath.normalPent(vC25, vC13, vC1, vC3, vC21, true);
        Pentad<Tuple<Apfloat>> pnt4 = new Pentad<>(vC25, vC21, vC11, vC8, vC17);
        Triad<Apfloat> pnt4_norm = VectorMath.normalPent(vC25, vC21, vC11, vC8, vC17, true);
        Pentad<Tuple<Apfloat>> pnt5 = new Pentad<>(vC25, vC17, vC4, vC5, vC13);
        Triad<Apfloat> pnt5_norm = VectorMath.normalPent(vC25, vC17, vC4, vC5, vC13, true);
        Pentad<Tuple<Apfloat>> pnt6 = new Pentad<>(vC26, vC14, vC2, vC0, vC22);
        Triad<Apfloat> pnt6_norm = VectorMath.normalPent(vC26, vC14, vC2, vC0, vC22, true);
        Pentad<Tuple<Apfloat>> pnt7 = new Pentad<>(vC26, vC22, vC8, vC11, vC18);
        Triad<Apfloat> pnt7_norm = VectorMath.normalPent(vC26, vC22, vC8, vC11, vC18, true);
        Pentad<Tuple<Apfloat>> pnt8 = new Pentad<>(vC26, vC18, vC7, vC6, vC14);
        Triad<Apfloat> pnt8_norm = VectorMath.normalPent(vC26, vC18, vC7, vC6, vC14, true);
        Pentad<Tuple<Apfloat>> pnt9 = new Pentad<>(vC27, vC15, vC3, vC1, vC23);
        Triad<Apfloat> pnt9_norm = VectorMath.normalPent(vC27, vC15, vC3, vC1, vC23, true);
        Pentad<Tuple<Apfloat>> pnt10 = new Pentad<>(vC27, vC23, vC9, vC10, vC19);
        Triad<Apfloat> pnt10_norm = VectorMath.normalPent(vC27, vC23, vC9, vC10, vC19, true);
        Pentad<Tuple<Apfloat>> pnt11 = new Pentad<>(vC27, vC19, vC6, vC7, vC15);
        Triad<Apfloat> pnt11_norm = VectorMath.normalPent(vC27, vC19, vC6, vC7, vC15, true);
        ...
        Triad<Apfloat> hex0_norm = VectorMath.normalHex(vC0, vC12, vC4, vC17, vC8, vC22, true);
        Hexad<Tuple<Apfloat>> hex1 = new Hexad<>(vC1, vC13, vC5, vC16, vC9, vC23);
        Triad<Apfloat> hex1_norm = VectorMath.normalHex(vC1, vC13, vC5, vC16, vC9, vC23, true);
        Hexad<Tuple<Apfloat>> hex2 = new Hexad<>(vC2, vC14, vC6, vC19, vC10, vC20);
        Triad<Apfloat> hex2_norm = VectorMath.normalHex(vC2, vC14, vC6, vC19, vC10, vC20, true);
        Hexad<Tuple<Apfloat>> hex3 = new Hexad<>(vC3, vC15, vC7, vC18, vC11, vC21);
        Triad<Apfloat> hex3_norm = VectorMath.normalHex(vC3, vC15, vC7, vC18, vC11, vC21, true);
