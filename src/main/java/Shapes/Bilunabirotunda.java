...
/**
 * {@link:<a href=https://dmccooey.com/polyhedra/Bilunabirotunda.txt>...</a>}
 */
...
public class Bilunabirotunda extends Shape {
    ...
    public Bilunabirotunda(
        ...
        Triad<Apfloat> pnt0_norm = VectorMath.normalPent(vC12, vC2, vC9, vC8, vC0, true);
        Pentad<Tuple<Apfloat>> pnt1 = new Pentad<>(vC12, vC4,  vC10, vC11, vC6);
        Triad<Apfloat> pnt1_norm = VectorMath.normalPent(vC12, vC4,  vC10, vC11, vC6, true);
        Pentad<Tuple<Apfloat>> pnt2 = new Pentad<>(vC13, vC1,  vC8,  vC9,  vC3);
        Triad<Apfloat> pnt2_norm = VectorMath.normalPent(vC13, vC1,  vC8,  vC9,  vC3, true);
        Pentad<Tuple<Apfloat>> pnt3 = new Pentad<>(vC13, vC7,  vC11, vC10, vC5);
        Triad<Apfloat> pnt3_norm = VectorMath.normalPent(vC13, vC7,  vC11, vC10, vC5, true);
        ...
        Triad<Apfloat> sqr0_norm = VectorMath.normalQuad(vC0, vC1, vC5, vC4, true);
        Tetrad<Tuple<Apfloat>> sqr1 = new Tetrad<>(vC3, vC2, vC6, vC7);
        Triad<Apfloat> sqr1_norm = VectorMath.normalQuad(vC3, vC2, vC6, vC7, true);
        faces_sqr = new Dyad<>(sqr0, sqr1);
        face_norms_sqr = new Dyad<>(sqr0_norm, sqr1_norm);

        // ==== TRIANGULAR FACES ====
        Triad<Tuple<Apfloat>> tri0 = new Triad<>(vC8,  vC1,  vC0);
        Triad<Apfloat> tri0_norm  = VectorMath.normalTriple(vC8, vC1, vC0, true);
        Triad<Tuple<Apfloat>> tri1 = new Triad<>(vC9,  vC2,  vC3);
        Triad<Apfloat> tri1_norm  = VectorMath.normalTriple(vC9,  vC2,  vC3, true);
        Triad<Tuple<Apfloat>> tri2 = new Triad<>(vC10, vC4,  vC5);
        Triad<Apfloat> tri2_norm  = VectorMath.normalTriple(vC10, vC4,  vC5, true);
        Triad<Tuple<Apfloat>> tri3 = new Triad<>(vC11, vC7,  vC6);
        Triad<Apfloat> tri3_norm  = VectorMath.normalTriple(vC11, vC7,  vC6, true);
        Triad<Tuple<Apfloat>> tri4 = new Triad<>(vC12, vC0,  vC4);
        Triad<Apfloat> tri4_norm  = VectorMath.normalTriple(vC12, vC0,  vC4, true);
        Triad<Tuple<Apfloat>> tri5 = new Triad<>(vC12, vC6,  vC2);
        Triad<Apfloat> tri5_norm  = VectorMath.normalTriple(vC12, vC6,  vC2, true);
        Triad<Tuple<Apfloat>> tri6 = new Triad<>(vC13, vC3,  vC7);
        Triad<Apfloat> tri6_norm  = VectorMath.normalTriple(vC13, vC3,  vC7, true);
        Triad<Tuple<Apfloat>> tri7 = new Triad<>(vC13, vC5,  vC1);
        Triad<Apfloat> tri7_norm  = VectorMath.normalTriple(vC13, vC5,  vC1, true);
